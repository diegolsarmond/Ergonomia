...
export const MOCK_COMPANIES: Company[] = [
  ...
  },
  {
    ...
    address: 'Av. Comercial, 3200 - Parque Industrial Norte, Manaus - AM, CEP 69075-000',
  ...
  },
  {
    ...
    address: 'Av. das Construções, 500 - Centro Empresarial, Belo Horizonte - MG, CEP 30130-110',
...
export const MOCK_UNITS: Unit[] = [
  {
    ...
    city: 'Guarulhos',
    uf: 'SP',
    address: 'Rua das Indústrias, 1500 - Distrito Industrial',
    productionLocation: 'Galpão principal – Linhas 1, 2 e 3',
    logoDataUrl: '',
  },
  {
    id: 'unit-2',
    ...
    city: 'Campinas',
    uf: 'SP',
    address: 'Rod. Dom Pedro I, km 68 - Parque Industrial',
    productionLocation: 'Galpão B – Linha de usinagem',
    logoDataUrl: '',
  },
  {
    id: 'unit-3',
    ...
    city: 'Manaus',
    uf: 'AM',
    address: 'Av. Comercial, 3200 - Parque Industrial Norte',
    productionLocation: 'Armazém geral + câmara fria',
    logoDataUrl: '',
  },
  {
    id: 'unit-4',
    ...
    city: 'Belo Horizonte',
    uf: 'MG',
    address: 'Av. das Construções, 500 - Centro Empresarial',
    productionLocation: 'Escritório + canteiro de obras ativo',
    logoDataUrl: '',
  },
];
...
export const MOCK_JOB_ROLES: StandardJobRole[] = [
  { id: 'role-1', name: 'Operador de Prensa', cbo: '7233-10', description: 'Operar prensas mecânicas e hidráulicas para estampagem de peças metálicas, seguindo as especificações técnicas e procedimentos de segurança.', active: true },
  { id: 'role-2', name: 'Auxiliar de Produção', cbo: '7831-05', description: 'Auxiliar no processo produtivo, realizando atividades de montagem, embalagem, etiquetagem e organização da linha de produção.', active: true },
  { id: 'role-3', name: 'Operador de Empilhadeira', cbo: '4141-05', description: 'Operar empilhadeiras para movimentação de cargas, paletização e organização do armazém ou pátio de expedição.', active: true },
  { id: 'role-4', name: 'Separador de Pedidos', cbo: '4141-05', description: 'Realizar a separação (picking) de produtos conforme pedidos de venda, utilizando coletores, carrinhos ou equipamentos de apoio.', active: true },
  { id: 'role-5', name: 'Assistente Administrativo', cbo: '4110-10', description: 'Executar atividades de suporte administrativo, controles de planilha, atendimento telefônico e gestão de documentos.', active: true },
  { id: 'role-6', name: 'Técnico de Manutenção', cbo: '9112-05', description: 'Realizar manutenção preventiva e corretiva em máquinas, equipamentos e instalações industriais.', active: true },
  { id: 'role-7', name: 'Inspetor de Qualidade', cbo: '3115-10', description: 'Inspecionar matérias-primas, produtos em processo e acabados, garantindo conformidade com especificações técnicas.', active: true },
];
