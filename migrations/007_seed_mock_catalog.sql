...
-- IDs derivados via md5(string)::uuid para manter legibilidade
-- e consistência com os IDs originais do código TypeScript.
-- ============================================================
...
-- ------------------------------------------------------------
INSERT INTO parametros_normativos_iluminancia (descricao_atividade, lux_minimo, irc_minimo, tolerancia_percentual, razao_uniformidade_max, referencia_normativa, referencia_pagina) VALUES
  ('Escritório — Escrita, leitura e processamento de dados',      500, 80, 10, 5, 'ABNT NBR ISO/CIE 8995-1:2013', 'Tabela 5.1'),
  ('Escritório — Recepção / hall de entrada',                     300, 80, 10, 5, 'ABNT NBR ISO/CIE 8995-1:2013', 'Tabela 5.1'),
  ('Sala de reunião e treinamento',                               500, 80, 10, 5, 'ABNT NBR ISO/CIE 8995-1:2013', 'Tabela 5.1'),
  ...
  ('Indústria — trabalho fino (montagem, ajuste, inspeção)',      500, 80, 10, 5, 'ABNT NBR ISO/CIE 8995-1:2013', 'Tabela 5.2'),
